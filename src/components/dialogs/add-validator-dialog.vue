  ...
  >
    <q-card class="custom-card">
      ...
      <q-card-section class="q-pt-none">
          ...
          <div class="row">
            <div class="col-md-5 col-12 q-mr-xl q-pt-md q-pb-md">
              ...
              <q-input
                ...
                hint="The staked AVAX tokens and rewards are sent to an account that is specified. The validation reward is also sent to the same account as the staked AVAX."
                lazy-rules
                :rules="[
                  val => val !== null && val !== '' ||
            ...
            <div class="col-md-5 col-12 q-pr-xl q-pt-md">
              <q-input
                ...
                type="number"
                label="Stake Amount *"
                hint="In order to validate the Default Subnet one must stake AVAX tokens. The minimum amount that one can stake is 10 μAVAX."
                lazy-rules outlined
                :rules="[
                  val => val !== null && val !== '' ||
        ...
        <sign-tx-dialog ref="signTxDialog" @txSend="close"/>
