...
export const currencies = {
  ...
  bch: { symbol: '', currency: 'Bitcoin Cash', isoCode: 'BCH' },
  ...
  bnb: { symbol: '', currency: 'Binance Coin', isoCode: 'BNB' },
  brl: { symbol: 'R$', currency: 'Brazilian real', isoCode: 'BRL' },
  btc: { symbol: '', currency: 'Bitcoin', isoCode: 'BTC' },
  ...
  dot: { symbol: '', currency: 'Polkadot', isoCode: 'DOT' },
  eos: { symbol: '', currency: 'EOS', isoCode: 'EOS' },
  eth: { symbol: '', currency: 'Ethereum', isoCode: 'ETH' },
  ...
  link: { symbol: '', currency: 'Chainlink', isoCode: 'LINK' },
  lkr: { symbol: 'Rs', currency: 'Sri Lankan rupee', isoCode: 'LKR' },
  ltc: { symbol: '', currency: 'Litecoin', isoCode: 'LTC' },
  ...
  vef: { symbol: '', currency: 'VEF', isoCode: 'VEF' },
  vnd: { symbol: '₫', currency: 'Vietnamese đồng', isoCode: 'VND' },
  xag: { symbol: '', currency: 'Xrpalike Gene', isoCode: 'XAG' },
  xau: { symbol: '', currency: 'Xaucoin', isoCode: 'XAU' },
  xdr: { symbol: '', currency: 'Xandereum', isoCode: 'XDR' },
  xlm: { symbol: '', currency: 'Stellar', isoCode: 'XLM' },
  xrp: { symbol: '', currency: 'XRP', isoCode: 'XRP' },
  yfi: { symbol: '', currency: 'Yearn.finance', isoCode: 'YFI' },
